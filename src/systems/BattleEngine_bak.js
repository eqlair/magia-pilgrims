...
export class BattleEngine {
    ...
    spawnEnemy(x, z, level, isSubBoss = false) {
        ...
        else if (frame === 2) { hp = 60; speed = 50; }
    ...
    update(dt) {
        ...
        for (const e of this.enemies) {
            ...
            if (e.x < -5) e.x = -5;
            if (e.x > 5) e.x = 5;
            if (e.z < -5) e.z = 25.0; // 画面手前(下)に抜けたら奥から再登場
        ...
        for (const b of this.bullets) {
            ...
            if (b.type && b.type.startsWith('swing_') && b.sourceEntity) {
                ...
                if (b.baseAngle !== undefined && b.baseAngle !== null) {
                    ...
                    const currentAngle = b.baseAngle - swingRange + (swingRange * 2) * progress;
            ...
            for (const t of targets) {
                ...
                if (distSq < r*r) {
                    ...
                    if (b.type === 'grenade') {
                        ...
                        if (isPiercing && !isSwing && b.type !== 'ultimate_003' && b.hitCount > 0) {
