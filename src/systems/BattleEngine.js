...
export const ENEMY_TYPES = [
    { id: 1, name: 'スウォーム', spawnCount: 9, hp: 15, speed: 3, moveDist: 6.0, moveInterval: 0.5, atkRange: 4.0, atkFreq: 0.5, atkPower: 1, weight: 5, debuffResist: 0, size: 0.5, textureKey: 'en003', frame: 0 },
    { id: 2, name: 'フライ', spawnCount: 4, hp: 30, speed: 2.5, moveDist: 4.5, moveInterval: 0.45, atkRange: 6.0, atkFreq: 0.5, atkPower: 1, weight: 10, debuffResist: 0, size: 0.75, textureKey: 'en003', frame: 1 },
    { id: 3, name: 'スピリット', spawnCount: 8, hp: 50, speed: 1.6, moveDist: 6.0, moveInterval: 0.4, atkRange: 6.0, atkFreq: 0.5, atkPower: 1, weight: 45, debuffResist: 50, size: 1.0, textureKey: 'en003', frame: 2 },
    { id: 4, name: 'マノウォー', spawnCount: 3, hp: 30, speed: 1, moveDist: 0.5, moveInterval: 0.1, atkRange: 8.0, atkFreq: 1.0, atkPower: 1, weight: 15, debuffResist: 50, size: 1.0, textureKey: 'en003', frame: 3 },
    { id: 5, name: 'ゴブリン', spawnCount: 8, hp: 50, speed: 10, moveDist: 0.8, moveInterval: 0.25, atkRange: 4.0, atkFreq: 0.5, atkPower: 1, weight: 35, debuffResist: 0, size: 0.5, textureKey: 'en001', frame: 2 },
    { id: 6, name: 'コボルド', spawnCount: 6, hp: 90, speed: 8, moveDist: 1.0, moveInterval: 0.35, atkRange: 6.0, atkFreq: 0.5, atkPower: 1, weight: 55, debuffResist: 50, size: 0.75, textureKey: 'en002', frame: 3 },
    { id: 7, name: 'オーク', spawnCount: 6, hp: 90, speed: 7, moveDist: 0.9, moveInterval: 0.5, atkRange: 8.0, atkFreq: 0.5, atkPower: 1, weight: 75, debuffResist: 0, size: 0.75, textureKey: 'en001', frame: 0 },
    { id: 8, name: 'オーガ', spawnCount: 3, hp: 125, speed: 6, moveDist: 1.25, moveInterval: 0.35, atkRange: 8.0, atkFreq: 0.5, atkPower: 1, weight: 110, debuffResist: 50, size: 1.0, textureKey: 'en002', frame: 2 },
    { id: 9, name: 'ゴーレム', spawnCount: 1, hp: 250, speed: 2, moveDist: 3.6, moveInterval: 0.6, atkRange: 4.0, atkFreq: 1.0, atkPower: 1, weight: 110, debuffResist: 50, size: 1.25, textureKey: 'en002', frame: 1 },
...
export class BattleEngine {
    ...
    applyDamage(attacker, defender, amount, type = 'normal', distance = 0, hitX = null, hitZ = null, isSureHit = false) {
        ...
        // 対人戦(PvP魔法少女戦)モード限定: 互いの攻撃ダメージを調整倍率(デフォルト1/20)にする
        if (this.isPvpBattle) {
            const gs = this.globalState || GlobalState.getInstance();
            const denom = (this.config && this.config.pvpDamageDenominator)
                ? this.config.pvpDamageDenominator
                : ((gs && gs.pvpDamageDenominator) ? gs.pvpDamageDenominator : 20);
    ...
    update(dt) {
        ...
        for (const b of this.bullets) {
            ...
            if (b.type === 'barrier_011' || b.type === 'barrier_010') {
                ...
                // 近接バリア(barrier_011): 0.5秒間で直径0.5mから2.0mへ滑らかに拡大！
