...
export class GlobalState {
    ...
    static ALLOW_DEBUG_TOGGLE = true; // デバッグ切り替え許可フラグ（デバッグモード時のみ有効化）
    ...
    constructor() {
        ...
        this.pvpDamageDenominator = 20;  // PvPダメージ分母 (デフォルト20 -> 1/20)
    ...
    createSnapshot() {
        return {
            ...
            pvpDamageDenominator: this.pvpDamageDenominator || 20,
...
// デバッグ版として起動された場合のみ隠しスイッチ（一時OFF/ONトグル）を有効化
GlobalState.ALLOW_DEBUG_TOGGLE = GlobalState.IS_DEBUG_MODE;
